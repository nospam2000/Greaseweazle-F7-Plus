...
JAVA_HOME=/Library/Java/JavaVirtualMachines/openjdk15/Contents/Home nice -n 20 java -jar ~/Downloads/Kicad/freerouting-1.4.4-executable.jar -di . -de Greaseweazle_F7_Plus_V2.bin -do Greaseweazle_F7_Plus_V2.ses -dr Greaseweazle_F7_Plus_V2.rules
